							...
							<div class="row">
								<div class="col-md-3">
									<div class="card shadow-sm">
										<img src="${pageContext.request.contextPath}/stay_image?name=${list.name}" width="100%" height="180px" />
										<div class="card-body">
											<div class="d-flex justify-content-between align-items-center">

												<span># ${list.region}</span> <br/>
												<span># 힐링</span> <br/>
												<span># 스테이</span> <br/>
												...
												<security:authorize access="hasAuthority('admin')">
													<form action="${pageContext.request.contextPath}/user/admin_delete" method="POST" onsubmit="return confirm('삭제하시겠습니까?');">
														...
														<input type="hidden" value="search" name="role">
								...
								<div class="col-md-9 mt-sm-20">
									...
									<p>${list.addr}</p>
									<div class="btn-group">
										<a href="${pageContext.request.contextPath}/stay_details?name=${list.name}">
					...
					<c:forEach var="list" items="${list1}">
						<div class="section-top-border">
							...
							<div class="row">
								<div class="col-md-3">
									<div class="card shadow-sm">
										<img src="${pageContext.request.contextPath}/food_image?name=${list.name}" width="100%" height="200px" />
										<div class="card-body">
											...
											<div
												...
												<span># ${list.region}</span> <br/>
												<span># ${list.kate}</span> <br/>
												<span># ${list.menu}</span> <br/>
								...
								<div class="col-md-7 mt-sm-20">
									...
									<div class="btn-group">
										<a
											href="${pageContext.request.contextPath}/food_details?name=${list.name}">
											<button class="btn btn-sm btn-outline-secondary">Go
												info</button>
										</a>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-3">
									<div class="card shadow-sm">
										...
										<img
											src="${pageContext.request.contextPath}/tour_image?name=${list.name}"
								...
								<div class="col-md-9 mt-sm-20">
									...
									<div class="btn-group">
										<a
											href="${pageContext.request.contextPath}/tour_details?name=${list.name}">
											<button class="btn btn-sm btn-outline-secondary">Go
												info</button>
										</a>
									</div>
