...
<link rel="stylesheet" href="resources/css/foodstore.css">
	...
	<main>
		...
		<div class="listing-caption section-padding2">
			<div class="container">
				...
				<c:forEach var="location" items="${list1}">
								<div class="row">
									<div class="col-md-4">
										<div class="card shadow-sm">
			                             <a href="${pageContext.request.contextPath}/food_details?name=${location.name}">
			                                 <img src="${pageContext.request.contextPath}/food_image?name=${location.name}" width="100%" height="270px" >
			                              </a>
		                             <div class="card-body">
									...
									<div class="col-md-8 mt-sm-20">
										<h2><a href="${pageContext.request.contextPath}/food_details?name=${location.name}">${location.name}</a></h2>
										<h4>${location.addr}</h4>
										<h6>${location.menu}</h6>
