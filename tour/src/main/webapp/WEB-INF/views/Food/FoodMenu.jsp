			...
			<div class="container">
				...
				<div class="listing-details-area">
					<div class="container">
 					...
 					<c:forEach var="location" items="${taglist}">
		                     <div class="col-lg-4 col-md-6">
		                         <div class="single-listing mb-30">
		                         
		                             <div class="list-img">
			                             <a href="${pageContext.request.contextPath}/food_details?name=${location.name}">
			                                 <img src="${pageContext.request.contextPath}/food_image?name=${location.name}" >
			                              </a>
		                             </div>
		                             <div class="list-caption">
		                                 <span>${location.region}</span>
		                                  <h3><a href="${pageContext.request.contextPath}/food_details?name=${location.name}">${location.name}</a></h3>
		                                 <p>${location.addr}</p>
		                                           ...
		                                           <security:authorize access="isAuthenticated()">
													<security:authorize access="hasAuthority('admin')">
															<form action="${pageContext.request.contextPath}/user/admin_delete" method="POST"  onsubmit="return confirm('삭제하시겠습니까?');">
																...
																<input type="hidden" value="food1" name="role">
