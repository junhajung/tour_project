...
<body>
	...
	<main>
		<div class="container section-padding30">
			...
			<div class="row">
				<form action="${pageContext.request.contextPath}/reply/batchupdate1" method="post" style="width: -webkit-fill-available;">
					<table class="table">
						<thead>
							<tr>
								<th scope="col">
									<input type="submit" value="[수정] " style="background-color: transparent; color: blue; border: 0px transparent solid; cursor: pointer;">
								</th>
						...
						<tbody>
							<c:forEach var="list" items="${list}">
								<tr>
									<td><input type="hidden" name="id[]" value="${list.id}" readonly></td>
