...
/*   flightPath = new google.maps.Ployline({
  ...
  var locations = [
	  ...
	  '<input type="hidden" value="${list.name}" name="name">' +
		  ...
		  '<div>제목 : <input  type="text" name="title" value="${list.title}" style="border-top: none; border-left: none; border-right: none; border-bottom : 1px solid black;" ></div>'+
		  '<br/>' +
		  ' <div>메모 : <input  type="text" name="memo" value="${list.memo}" style="border-top: none; border-left: none; border-right: none; border-bottom : 1px solid black;"></div>' +
		  '<br/>' +
		  ' <div>주소 : <input  type="text" name="addr" value="${list.addr}" style="border-top: none; border-left: none; border-right: none; border-bottom : 1px solid black;" readonly></div>' +
		  '<br/>' +
		  '<div> <input type="submit" value="수정하기"><br/></div>' +
	  '</form>' +
		  '<div><a href="${pageContext.request.contextPath}/delete?name=${list.name}"><br/><p>삭제</p></a></div>'+
		  '<div><a href="${pageContext.request.contextPath}/mymap_detail?name=${list.name}"><br/><p>상세보기</p></a></div>'
	  ,  ${list.lat}, ${list.lng}],
	  </c:forEach>  
    ];
